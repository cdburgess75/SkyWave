...
**Version:** v2026.07.13.003 (CalVer: `YYYY.MM.DD`, `.00N` suffix for same-day releases)
**Date:** June 2026
...
- **`const VERSION="2026.07.13.003"` near the top** of the script block. CalVer: `YYYY.MM.DD`; append `.00N` for same-day releases. Bump the `sw.js` cache name in the same commit.
